...
<div>
  ...
  <div class="login-wrap">
    ...
    <el-form class="login-container" ref="form" v-model="form" >
      <h1 class="title">用户登录：</h1>
      <el-form-item>
        <el-input type="text" placeholder="用户账号" v-model="form.tNickname" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item>
        <el-input type="password" placeholder="用户密码" v-model="form.tPassword" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item>
...
import NavBarVue from '../components/NavBar.vue';
  export default {
    ...
    methods: {
      doLogin(){
        this.$axios.post('http://localhost:80/tenant/login.do',this.form).then(res=>{
            let logininfo={
                LoginName:this.form.tNickname,
                openId:"astfofo"
            }
                if(res.data.info.tid>=0){
