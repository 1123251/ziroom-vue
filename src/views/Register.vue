...
<div>
  ...
  <div class="login-wrap">
    <el-form class="login-container" ref="form" v-model="form">
      ...
      <el-form-item>
        <el-input type="text" placeholder="用户手机" v-model="form.tPhone" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item>
...
import NavBarVue from '../components/NavBar.vue';
  export default {
    ...
    methods: {
      doRegister:function(){
  this.$axios.post('http://localhost:80/tenant/register.do',this.form).then(res=>{
